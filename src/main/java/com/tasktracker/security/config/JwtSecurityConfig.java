...
public class JwtSecurityConfig {
    ...
    public JwtSecurityConfig(AuthenticationFilter filter) {
        this.filter = filter;
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider provider) throws Exception {
        return http.csrf(
                ...
                (authorizationManagerRequestMatcherRegistry) ->
                        authorizationManagerRequestMatcherRegistry
                                // Публичные endpoints согласно ТЗ
                                .requestMatchers("/api/auth/**").permitAll()

                                // Admin-only endpoints согласно ТЗ
                                .requestMatchers("/api/admin/**").hasRole("ADMIN")

                                // Для всех авторизованных (USER и ADMIN) согласно ТЗ
